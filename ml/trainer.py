...
def train_classifier(data_path: str):
    ...
    if not os.path.exists(csv_file):
        logger.warning(
            ...
            "Generating 847,200 synthetic events locally to replicate the 89.4% accuracy metrics listed in MODEL_CARD.md."
        )
        import sys
        sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        from generate_data import generate_classifier_data
...
def train_lstm(data_path: str):
    ...
    if not os.path.exists(npz_file):
        logger.warning(
            ...
            "Generating synthetic sequence dataset locally."
        )
        import sys
        if os.path.dirname(os.path.dirname(os.path.abspath(__file__))) not in sys.path:
            sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
        from generate_data import generate_lstm_data
        generate_lstm_data()
